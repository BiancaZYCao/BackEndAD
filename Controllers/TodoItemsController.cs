...
/*This is an example from official Tutorial
 * 1)For simplify, here it directly call databaseContext to retrieve data. 
 *      Our implementation should use service layer instead.
 *      To see more details, pls check DeptController.
 * 2) However, u can find EntityDTO here in case u need it. 
 *      (DTO is sightly different from entity itself means u can hide some data when u pass the object.)
    */
