...
public static class DBSeed
{
    ...
    public static bool Initialize(IUnitOfWork<ProjectContext> unitOfWork)
    {
        ...
        i60, i61, i62, i63, i64, i65, i66, i67, i68, i69, i70, i71, i72, i73, i74, i75, i76, i77, i78, i79, i80, i81, i82, i83, i84, i85, i86, i87, i88, i89};
            ...
            SupplierItem si1 = new SupplierItem() { SupplierId = 1, StationeryItem = i2, price = 1.2, unit = "Dozen" };
            SupplierItem si2 = new SupplierItem() { SupplierId = 1, StationeryItem = i3, price = 1, unit = "Dozen" };
            SupplierItem si3 = new SupplierItem() { SupplierId = 1, StationeryItem = i4, price = 5, unit = "Box" };
            SupplierItem si4 = new SupplierItem() { SupplierId = 1, StationeryItem = i5, price = 7, unit = "Box" };
            SupplierItem si5 = new SupplierItem() { SupplierId = 1, StationeryItem = i6, price = 7.5, unit = "Box" };
            SupplierItem si6 = new SupplierItem() { SupplierId = 1, StationeryItem = i7, price = 0.4, unit = "Each" };
            SupplierItem si7 = new SupplierItem() { SupplierId = 1, StationeryItem = i8, price = 0.56, unit = "Each" };
            SupplierItem si8 = new SupplierItem() { SupplierId = 1, StationeryItem = i9, price = 0.3, unit = "Each" };
            SupplierItem si9 = new SupplierItem() { SupplierId = 1, StationeryItem = i10, price = 0.35, unit = "Each" };
            SupplierItem si10= new SupplierItem() { SupplierId = 1, StationeryItem = i12, price = 0.4, unit = "Each" };
            SupplierItem si11= new SupplierItem() { SupplierId = 1, StationeryItem = i13, price = 0.38, unit = "Each" };
            SupplierItem si12= new SupplierItem() { SupplierId = 1, StationeryItem = i14, price = 0.22, unit = "Each" };
            SupplierItem si13= new SupplierItem() { SupplierId = 1, StationeryItem = i15, price = 0.38, unit = "Each" };
            SupplierItem si14= new SupplierItem() { SupplierId = 1, StationeryItem = i16, price = 0.35, unit = "Each" };
            SupplierItem si15= new SupplierItem() { SupplierId = 1, StationeryItem = i17, price = 0.5, unit = "Each" };
            SupplierItem si16= new SupplierItem() { SupplierId = 1, StationeryItem = i18, price = 0.4, unit = "Each" };
            SupplierItem si17= new SupplierItem() { SupplierId = 1, StationeryItem = i19, price = 0.3, unit = "Each" };
            SupplierItem si18= new SupplierItem() { SupplierId = 1, StationeryItem = i20, price = 0.46, unit = "Each" };
            SupplierItem si19= new SupplierItem() { SupplierId = 1, StationeryItem = i22, price = 0.3, unit = "Each" };
            SupplierItem si20= new SupplierItem() { SupplierId = 1, StationeryItem = i23, price = 0.39, unit = "Each" };
            SupplierItem si21 = new SupplierItem() { SupplierId = 1, StationeryItem = i24, price = 8, unit = "Set" };
            SupplierItem si22 = new SupplierItem() { SupplierId = 1, StationeryItem = i25, price = 16, unit = "Each" };
            SupplierItem si23 = new SupplierItem() { SupplierId = 1, StationeryItem = i26, price = 18, unit = "Each" };
            SupplierItem si24 = new SupplierItem() { SupplierId = 1, StationeryItem = i27, price = 16, unit = "Each" };
            SupplierItem si25 = new SupplierItem() { SupplierId = 1, StationeryItem = i28, price = 18, unit = "Each" };
            SupplierItem si26 = new SupplierItem() { SupplierId = 1, StationeryItem = i29, price = 0.2, unit = "Each" };
            SupplierItem si27 = new SupplierItem() { SupplierId = 1, StationeryItem = i30, price = 0.2, unit = "Each" };
            SupplierItem si28 = new SupplierItem() { SupplierId = 1, StationeryItem = i32, price = 0.2, unit = "Each" };
            SupplierItem si29 = new SupplierItem() { SupplierId = 1, StationeryItem = i33, price = 0.2, unit = "Each" };
            SupplierItem si30 = new SupplierItem() { SupplierId = 1, StationeryItem = i34, price = 8.99, unit = "Box" };
            SupplierItem si31 = new SupplierItem() { SupplierId = 1, StationeryItem = i35, price = 8.99, unit = "Box" };
            SupplierItem si32 = new SupplierItem() { SupplierId = 1, StationeryItem = i36, price = 8.99, unit = "Box" };
            SupplierItem si33 = new SupplierItem() { SupplierId = 1, StationeryItem = i37, price = 8.99, unit = "Box" };
            SupplierItem si34 = new SupplierItem() { SupplierId = 1, StationeryItem = i38, price = 6, unit = "Each" };
            SupplierItem si35 = new SupplierItem() { SupplierId = 1, StationeryItem = i39, price = 7, unit = "Each" };
            SupplierItem si36 = new SupplierItem() { SupplierId = 1, StationeryItem = i40, price = 20, unit = "Each" };
            SupplierItem si37 = new SupplierItem() { SupplierId = 1, StationeryItem = i42, price = 12.99, unit = "Packet" };
            SupplierItem si38 = new SupplierItem() { SupplierId = 1, StationeryItem = i43, price = 12.99, unit = "Packet" };
            SupplierItem si39 = new SupplierItem() { SupplierId = 1, StationeryItem = i44, price = 16.99, unit = "Packet" };
            SupplierItem si40 = new SupplierItem() { SupplierId = 1, StationeryItem = i45, price = 19.99, unit = "Packet" };
            SupplierItem si41 = new SupplierItem() { SupplierId = 1, StationeryItem = i46, price = 19.99, unit = "Packet" };
            SupplierItem si42 = new SupplierItem() { SupplierId = 1, StationeryItem = i47, price = 10.99, unit = "Packet" };
            SupplierItem si43 = new SupplierItem() { SupplierId = 1, StationeryItem = i48, price = 10, unit = "Box" };
            SupplierItem si44 = new SupplierItem() { SupplierId = 1, StationeryItem = i49, price = 4, unit = "Box" };
            SupplierItem si45 = new SupplierItem() { SupplierId = 1, StationeryItem = i50, price = 5.99, unit = "Dozen" };
            SupplierItem si46 = new SupplierItem() { SupplierId = 1, StationeryItem = i52, price = 5.99, unit = "Dozen" };
            SupplierItem si47 = new SupplierItem() { SupplierId = 1, StationeryItem = i53, price = 13.99, unit = "Dozen" };
            SupplierItem si48 = new SupplierItem() { SupplierId = 1, StationeryItem = i54, price = 13.99, unit = "Dozen" };
            SupplierItem si49 = new SupplierItem() { SupplierId = 1, StationeryItem = i55, price = 13.99, unit = "Dozen" };
            SupplierItem si50 = new SupplierItem() { SupplierId = 1, StationeryItem = i56, price = 5.99, unit = "Packet" };
            SupplierItem si51 = new SupplierItem() { SupplierId = 1, StationeryItem = i57, price = 8.99, unit = "Packet" };
            SupplierItem si52 = new SupplierItem() { SupplierId = 1, StationeryItem = i58, price = 6, unit = "Box" };
            SupplierItem si53 = new SupplierItem() { SupplierId = 1, StationeryItem = i59, price = 8.5, unit = "Box" };
            SupplierItem si54 = new SupplierItem() { SupplierId = 1, StationeryItem = i60, price = 8.5, unit = "Box" };
            SupplierItem si55 = new SupplierItem() { SupplierId = 1, StationeryItem = i62, price = 2.8, unit = "Dozen" };
            SupplierItem si56 = new SupplierItem() { SupplierId = 1, StationeryItem = i63, price = 3.6, unit = "Dozen" };
            SupplierItem si57 = new SupplierItem() { SupplierId = 1, StationeryItem = i64, price = 2.4, unit = "Dozen" };
            SupplierItem si58 = new SupplierItem() { SupplierId = 1, StationeryItem = i65, price = 3.6, unit = "Dozen" };
            SupplierItem si59 = new SupplierItem() { SupplierId = 1, StationeryItem = i66, price = 4, unit = "Dozen" };
            SupplierItem si60 = new SupplierItem() { SupplierId = 1, StationeryItem = i67, price = 3.9, unit = "Dozen" };
            SupplierItem si61 = new SupplierItem() { SupplierId = 1, StationeryItem = i68, price = 2.2, unit = "Each" };
            SupplierItem si62 = new SupplierItem() { SupplierId = 1, StationeryItem = i69, price = 4.9, unit = "Each" };
            SupplierItem si63 = new SupplierItem() { SupplierId = 1, StationeryItem = i70, price = 2.5, unit = "Each" };
            SupplierItem si64 = new SupplierItem() { SupplierId = 1, StationeryItem = i72, price = 5.9, unit = "Each" };
            SupplierItem si65 = new SupplierItem() { SupplierId = 1, StationeryItem = i73, price = 16.2, unit = "Each" };
            SupplierItem si66 = new SupplierItem() { SupplierId = 1, StationeryItem = i74, price = 20, unit = "Each" };
            SupplierItem si67 = new SupplierItem() { SupplierId = 1, StationeryItem = i75, price = 12.2, unit = "Each" };
            SupplierItem si68 = new SupplierItem() { SupplierId = 1, StationeryItem = i76, price = 2.5, unit = "Each" };
            SupplierItem si69 = new SupplierItem() { SupplierId = 1, StationeryItem = i77, price = 3.5, unit = "Each" };
            SupplierItem si70 = new SupplierItem() { SupplierId = 1, StationeryItem = i78, price = 10.5, unit = "Box" };
            SupplierItem si71 = new SupplierItem() { SupplierId = 1, StationeryItem = i79, price = 12.5, unit = "Box" };
            SupplierItem si72 = new SupplierItem() { SupplierId = 1, StationeryItem = i80, price = 7.2, unit = "Box" };
            SupplierItem si73 = new SupplierItem() { SupplierId = 1, StationeryItem = i82, price = 3.4, unit = "Box" };
            SupplierItem si74 = new SupplierItem() { SupplierId = 1, StationeryItem = i83, price = 12, unit = "Box" };
            SupplierItem si75 = new SupplierItem() { SupplierId = 1, StationeryItem = i84, price = 12, unit = "Box" };
            SupplierItem si76 = new SupplierItem() { SupplierId = 1, StationeryItem = i85, price = 12, unit = "Box" };
            SupplierItem si77 = new SupplierItem() { SupplierId = 1, StationeryItem = i86, price = 12, unit = "Box" };
            SupplierItem si78 = new SupplierItem() { SupplierId = 1, StationeryItem = i87, price = 12, unit = "Box" };
            SupplierItem si79 = new SupplierItem() { SupplierId = 1, StationeryItem = i88, price = 10, unit = "Box" };
            SupplierItem si80 = new SupplierItem() { SupplierId = 1, StationeryItem = i89, price = 12, unit = "Set" };
           
            SupplierItem si81 = new SupplierItem() {SupplierId = 2, StationeryItem = i11, price = 0.2, unit = "Each"};
            SupplierItem si82 = new SupplierItem() { SupplierId = 2, StationeryItem = i21, price = 0.62, unit = "Each" };
            SupplierItem si83 = new SupplierItem() { SupplierId = 2, StationeryItem = i31, price = 0.2, unit = "Each" };
            SupplierItem si84 = new SupplierItem() { SupplierId = 2, StationeryItem = i41, price = 13.99, unit = "Packet" };
            SupplierItem si85 = new SupplierItem() { SupplierId = 2, StationeryItem = i51, price = 5.99, unit = "Dozen" };
            SupplierItem si86 = new SupplierItem() { SupplierId = 2, StationeryItem = i61, price = 8.5, unit = "Box" };
            SupplierItem si87 = new SupplierItem() { SupplierId = 2, StationeryItem = i71, price = 2.2, unit = "Each" };
            SupplierItem si88 = new SupplierItem() { SupplierId = 2, StationeryItem = i81, price = 5.2, unit = "Box" };
            SupplierItem si89 = new SupplierItem() { SupplierId = 2, StationeryItem = i9, price = 0.5, unit = "Each" };
            SupplierItem si90 = new SupplierItem() { SupplierId = 2, StationeryItem = i10, price = 0.55, unit = "Each" };

            SupplierItem si91 = new SupplierItem() {SupplierId = 3, StationeryItem = i15, price = 0.45, unit = "Each"};
            SupplierItem si92 = new SupplierItem() { SupplierId = 3, StationeryItem = i25, price = 16.8, unit = "Each" };
            SupplierItem si93 = new SupplierItem() { SupplierId = 3, StationeryItem = i35, price = 9.99, unit = "Box" };
            SupplierItem si94 = new SupplierItem() { SupplierId = 3, StationeryItem = i45, price = 21.8, unit = "Packet" };
            SupplierItem si95 = new SupplierItem() { SupplierId = 3, StationeryItem = i55, price = 15.99, unit = "Dozen" };
            #endregion
            /*
            //Done May only 2 
